...
export default function Menu() {
    ...
    return (
        <>
            <div className="w-full h-20 bg-light shadow-md px-10 m-auto flex justify-between items-center fixed lg:px-40 ">
            ...
            {showMenu && (
                <div className="bg-light w-full h-[24vh] fixed shadow-md top-20 lg:hidden " >
